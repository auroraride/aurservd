            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/definition.EbikeDetailRes"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/definition.PlanNewlyRes"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/definition.RiderSignupReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "definition.OrderCreateReq": {
            ...
            "properties": {
                ...
                "payway": {
                    "description": "支付方式, 1支付宝 2微信 3支付宝预授权(仅限V2使用) 5 支付宝小程序",
                    "type": "integer",
                    "enum": [
                        1,
                        2,
        ...
        "definition.OrderDepositCreditReq": {
            ...
            "properties": {
                "payway": {
                    "description": "支付方式, 1支付宝 2微信 3支付宝信用免押 4微信支付分",
                    "type": "integer",
                    "enum": [
                        1,
                        2,
