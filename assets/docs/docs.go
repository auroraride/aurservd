    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "items": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/controller.CrmCustomerWithID"
                                            }
                                        }
                                    }
                                }
        ...
        "/manager/v1/enterprise/cabinet": {
            "put": {
                ...
                "operationId": "ManagerEnterpriseModifyCabinet",
                "parameters": [
                    {
                        "description": "编辑电柜请求",
                        "name": "body",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CabinetAgentEditReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/manager/v1/enterprise/rider/active": {
            "put": {
                "consumes": [
                    "application/json"
                ],
                ...
                "summary": "M9028 激活骑手",
                "operationId": "ManagerEnterpriseActiveRider",
                "parameters": [
                    {
                        "description": "激活骑手请求",
                        "name": "body",
        ...
        "/manager/v1/enterprise/rider/unbind": {
            "put": {
                "consumes": [
                    "application/json"
                ],
                ...
                "summary": "M9029 解绑骑手",
                "operationId": "ManagerEnterpriseUnbindRider",
                "parameters": [
                    {
                        "description": "解绑骑手请求",
                        "name": "body",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.RiderUnbindBatteryReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.RiderCodeLoginReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.AgentRider": {
            ...
            "properties": {
                ...
                "model": {
                    "description": "SubscribeID uint64 ` + "`" + `json:\"subscribeId\"` + "`" + `     // 订阅ID",
                    "type": "string"
                },
                "name": {
                    "description": "姓名",
                ...
                "station": {
                    "description": "City        *City  ` + "`" + `json:\"city,omitempty\"` + "`" + `      // 城市\nDate        string ` + "`" + `json:\"date\"` + "`" + `            // 创建日期",
                    "type": "string"
                },
                "status": {
                    "description": "状态",
                ...
                "stopAt": {
                    "description": "EndAt       string ` + "`" + `json:\"endAt\"` + "`" + `           // 退租日期",
                    "type": "string"
                }
            }
        },
