...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/warestore/v2/assets/attributes": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/assets/{id}": {
            "put": {
                ...
                "summary": "修改资产",
                "operationId": "WarestoreAssetsUpdate",
                "parameters": [
                    {
                        "type": "string",
                        "description": "仓管校验token",
        ...
        "/warestore/v2/cabinet/{serial}/{ordinal}": {
            "post": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/duty/check": {
            "post": {
                ...
                "summary": "上班范围检查",
                "operationId": "WarestoreCheckDuty",
                "parameters": [
                    {
                        "type": "string",
                        "description": "仓管校验token",
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/definition.WarestoreCheckDutyRes"
                        }
                    }
                }
            }
        ...
        "/warestore/v2/selection/city_station": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/selection/ebike/brand": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/selection/employee_store": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "summary": "店员所属门店列表",
                "operationId": "SelectionEmployeeStores",
                "parameters": [
                    {
                        "type": "string",
                        "description": "仓管校验token",
        ...
        "/warestore/v2/selection/enterprise": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/selection/maintainer": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/selection/manager_warehouse": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "summary": "仓管所属仓库列表",
                "operationId": "SelectionManagerWarehouse",
                "parameters": [
                    {
                        "type": "string",
                        "description": "仓管校验token",
        ...
        "/warestore/v2/selection/station": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/selection/warehouse": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/warestore/v2/transfer/cancel/{id}": {
            "put": {
                "consumes": [
                    "application/json"
                ],
    ...
    "definitions": {
        ...
        "definition.WarestoreCheckDutyRes": {
            "type": "object",
            "properties": {
                "name": {
                    "description": "上班位置名称",
        ...
        "definition.WarestorePeopleSigninReq": {
            ...
            "properties": {
                ...
                "platType": {
                    "description": "登录平台类型, 1-仓库平台 2-门店平台",
                    "enum": [
                        1,
                        2
                    ],
