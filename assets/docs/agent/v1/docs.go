...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/agent/v1/selection/city_station": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/agent/v1/selection/ebike/brand": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/agent/v1/transfer/{id}": {
            "get": {
                ...
                "summary": "调拨记录详情",
                "operationId": "AgentTransferDetail",
                "parameters": [
                    {
                        "type": "string",
                        "description": "仓管校验token",
