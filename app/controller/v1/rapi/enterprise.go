...
func (*enterprise) RiderEnterpriseInfo(c echo.Context) (err error) {
	...
	return ctx.SendResponse(service.NewEnterpriseRider().RiderEnterpriseInfo(req, ctx.Rider))
}
