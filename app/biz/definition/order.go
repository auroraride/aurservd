...
type OrderDepositCreditReq struct {
	...
	Payway uint8  `json:"payway" validate:"required" trans:"支付方式" enums:"1,2,3,4"` //  1支付宝 2微信 3支付宝信用免押 4微信支付分
}
...
type OrderCreateReq struct {
	...
	Payway    uint8  `json:"payway" validate:"required" trans:"支付方式" enums:"1,2,3,5"`          // 1支付宝 2微信 3支付宝预授权(仅限V2使用) 5 支付宝小程序
	...
	DepositAlipayAuthFreeze bool               `json:"depositAlipayAuthFreeze"` // 是否使用支付宝预授权信用分支付押金 	// 以下字段仅限V2使用
	...
	BuyerOpenId             *string            `json:"buyerOpenId"`             // 买家支付宝用户ID
}
