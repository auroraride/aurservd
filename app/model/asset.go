...
type AssetFilter struct {
	...
	RentLocationsType *AssetLocationsType `json:"rentLocationsType" query:"rentLocationsType" enums:"1,2,3,4,5,6"` // 出租位置类型 1:仓库 2:门店 3:站点 4:运维 5:电柜 6:骑手
	RentLocationsID   *uint64             `json:"rentLocationsID" query:"rentLocationsID"`                         // 出租位置ID
}
...
type AssetListRes struct {
	...
	RentLocations   string                    `json:"rentLocations"`    // 出租位置
	RentLocationsID uint64                    `json:"rentLocationsID"`  // 出租位置ID
}
