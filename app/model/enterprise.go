...
type AgentIndexRes struct {
	EnterpriseAmountSummary
	EnterpriseRiderSummary
	EnterpriseBatterySummary
}

// EnterpriseAmountSummary 团签金额汇总
type EnterpriseAmountSummary struct {
	// 余额
...
// EnterpriseRiderSummary 团签骑手数据汇总
type EnterpriseRiderSummary struct {
...
// EnterpriseBatterySummary 团签电池汇总
type EnterpriseBatterySummary struct {
	// 电池总数
