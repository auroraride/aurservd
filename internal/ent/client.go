...
type (
	hooks struct {
		...
		PromotionCommission, PromotionEarnings, PromotionGrowth, PromotionLevel,
		PromotionLevelTask, PromotionMember, PromotionPerson, PromotionPrivilege,
		PromotionReferrals, PromotionSetting, PromotionWithdrawal, Reserve, Rider,
