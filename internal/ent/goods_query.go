...
func (gq *GoodsQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (gq *GoodsQuery) FirstIDX(ctx context.Context) uint64 {
...
func (gq *GoodsQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (gq *GoodsQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (gq *GoodsQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (gq *GoodsQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := gq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (gq *GoodsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(goods.Table, goods.Columns, sqlgraph.NewFieldSpec(goods.FieldID, field.TypeUint64))
	_spec.From = gq.sql
