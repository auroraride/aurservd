...
type OrderRefund struct {
	...
	// OutRefundNo holds the value of the "out_refund_no" field.
	// 退款订单编号
...
func (*OrderRefund) scanValues(columns []string) ([]interface{}, error) {
...
func (or *OrderRefund) assignValues(columns []string, values []interface{}) error {
