...
func (esu *EnterpriseStatementUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *EnterpriseStatementUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (esuo *EnterpriseStatementUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *EnterpriseStatementUpdateOne {
