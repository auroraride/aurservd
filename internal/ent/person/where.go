...
// IDCardHead applies equality check predicate on the "id_card_head" field. It's identical to IDCardHeadEQ.
func IDCardHead(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldIDCardHead, v))
}
...
// CertifyID applies equality check predicate on the "certify_id" field. It's identical to CertifyIDEQ.
func CertifyID(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldCertifyID, v))
}

// WbOcrOrderNo applies equality check predicate on the "wb_ocr_order_no" field. It's identical to WbOcrOrderNoEQ.
func WbOcrOrderNo(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldWbOcrOrderNo, v))
}

// WbFaceOrderNo applies equality check predicate on the "wb_face_order_no" field. It's identical to WbFaceOrderNoEQ.
func WbFaceOrderNo(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldWbFaceOrderNo, v))
}
...
// IDCardHeadEQ applies the EQ predicate on the "id_card_head" field.
func IDCardHeadEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldIDCardHead, v))
}

// IDCardHeadNEQ applies the NEQ predicate on the "id_card_head" field.
func IDCardHeadNEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldNEQ(FieldIDCardHead, v))
}

// IDCardHeadIn applies the In predicate on the "id_card_head" field.
func IDCardHeadIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldIn(FieldIDCardHead, vs...))
}

// IDCardHeadNotIn applies the NotIn predicate on the "id_card_head" field.
func IDCardHeadNotIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldNotIn(FieldIDCardHead, vs...))
}

// IDCardHeadGT applies the GT predicate on the "id_card_head" field.
func IDCardHeadGT(v string) predicate.Person {
	return predicate.Person(sql.FieldGT(FieldIDCardHead, v))
}

// IDCardHeadGTE applies the GTE predicate on the "id_card_head" field.
func IDCardHeadGTE(v string) predicate.Person {
	return predicate.Person(sql.FieldGTE(FieldIDCardHead, v))
}

// IDCardHeadLT applies the LT predicate on the "id_card_head" field.
func IDCardHeadLT(v string) predicate.Person {
	return predicate.Person(sql.FieldLT(FieldIDCardHead, v))
}

// IDCardHeadLTE applies the LTE predicate on the "id_card_head" field.
func IDCardHeadLTE(v string) predicate.Person {
	return predicate.Person(sql.FieldLTE(FieldIDCardHead, v))
}

// IDCardHeadContains applies the Contains predicate on the "id_card_head" field.
func IDCardHeadContains(v string) predicate.Person {
	return predicate.Person(sql.FieldContains(FieldIDCardHead, v))
}

// IDCardHeadHasPrefix applies the HasPrefix predicate on the "id_card_head" field.
func IDCardHeadHasPrefix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasPrefix(FieldIDCardHead, v))
}

// IDCardHeadHasSuffix applies the HasSuffix predicate on the "id_card_head" field.
func IDCardHeadHasSuffix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasSuffix(FieldIDCardHead, v))
}

// IDCardHeadIsNil applies the IsNil predicate on the "id_card_head" field.
func IDCardHeadIsNil() predicate.Person {
	return predicate.Person(sql.FieldIsNull(FieldIDCardHead))
}

// IDCardHeadNotNil applies the NotNil predicate on the "id_card_head" field.
func IDCardHeadNotNil() predicate.Person {
	return predicate.Person(sql.FieldNotNull(FieldIDCardHead))
}

// IDCardHeadEqualFold applies the EqualFold predicate on the "id_card_head" field.
func IDCardHeadEqualFold(v string) predicate.Person {
	return predicate.Person(sql.FieldEqualFold(FieldIDCardHead, v))
}

// IDCardHeadContainsFold applies the ContainsFold predicate on the "id_card_head" field.
func IDCardHeadContainsFold(v string) predicate.Person {
	return predicate.Person(sql.FieldContainsFold(FieldIDCardHead, v))
}
...
// CertifyIDEQ applies the EQ predicate on the "certify_id" field.
func CertifyIDEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldCertifyID, v))
}

// CertifyIDNEQ applies the NEQ predicate on the "certify_id" field.
func CertifyIDNEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldNEQ(FieldCertifyID, v))
}

// CertifyIDIn applies the In predicate on the "certify_id" field.
func CertifyIDIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldIn(FieldCertifyID, vs...))
}

// CertifyIDNotIn applies the NotIn predicate on the "certify_id" field.
func CertifyIDNotIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldNotIn(FieldCertifyID, vs...))
}

// CertifyIDGT applies the GT predicate on the "certify_id" field.
func CertifyIDGT(v string) predicate.Person {
	return predicate.Person(sql.FieldGT(FieldCertifyID, v))
}

// CertifyIDGTE applies the GTE predicate on the "certify_id" field.
func CertifyIDGTE(v string) predicate.Person {
	return predicate.Person(sql.FieldGTE(FieldCertifyID, v))
}

// CertifyIDLT applies the LT predicate on the "certify_id" field.
func CertifyIDLT(v string) predicate.Person {
	return predicate.Person(sql.FieldLT(FieldCertifyID, v))
}

// CertifyIDLTE applies the LTE predicate on the "certify_id" field.
func CertifyIDLTE(v string) predicate.Person {
	return predicate.Person(sql.FieldLTE(FieldCertifyID, v))
}

// CertifyIDContains applies the Contains predicate on the "certify_id" field.
func CertifyIDContains(v string) predicate.Person {
	return predicate.Person(sql.FieldContains(FieldCertifyID, v))
}

// CertifyIDHasPrefix applies the HasPrefix predicate on the "certify_id" field.
func CertifyIDHasPrefix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasPrefix(FieldCertifyID, v))
}

// CertifyIDHasSuffix applies the HasSuffix predicate on the "certify_id" field.
func CertifyIDHasSuffix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasSuffix(FieldCertifyID, v))
}

// CertifyIDIsNil applies the IsNil predicate on the "certify_id" field.
func CertifyIDIsNil() predicate.Person {
	return predicate.Person(sql.FieldIsNull(FieldCertifyID))
}

// CertifyIDNotNil applies the NotNil predicate on the "certify_id" field.
func CertifyIDNotNil() predicate.Person {
	return predicate.Person(sql.FieldNotNull(FieldCertifyID))
}

// CertifyIDEqualFold applies the EqualFold predicate on the "certify_id" field.
func CertifyIDEqualFold(v string) predicate.Person {
	return predicate.Person(sql.FieldEqualFold(FieldCertifyID, v))
}

// CertifyIDContainsFold applies the ContainsFold predicate on the "certify_id" field.
func CertifyIDContainsFold(v string) predicate.Person {
	return predicate.Person(sql.FieldContainsFold(FieldCertifyID, v))
}

// WbOcrOrderNoEQ applies the EQ predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoNEQ applies the NEQ predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoNEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldNEQ(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoIn applies the In predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldIn(FieldWbOcrOrderNo, vs...))
}

// WbOcrOrderNoNotIn applies the NotIn predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoNotIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldNotIn(FieldWbOcrOrderNo, vs...))
}

// WbOcrOrderNoGT applies the GT predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoGT(v string) predicate.Person {
	return predicate.Person(sql.FieldGT(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoGTE applies the GTE predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoGTE(v string) predicate.Person {
	return predicate.Person(sql.FieldGTE(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoLT applies the LT predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoLT(v string) predicate.Person {
	return predicate.Person(sql.FieldLT(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoLTE applies the LTE predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoLTE(v string) predicate.Person {
	return predicate.Person(sql.FieldLTE(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoContains applies the Contains predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoContains(v string) predicate.Person {
	return predicate.Person(sql.FieldContains(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoHasPrefix applies the HasPrefix predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoHasPrefix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasPrefix(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoHasSuffix applies the HasSuffix predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoHasSuffix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasSuffix(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoIsNil applies the IsNil predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoIsNil() predicate.Person {
	return predicate.Person(sql.FieldIsNull(FieldWbOcrOrderNo))
}

// WbOcrOrderNoNotNil applies the NotNil predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoNotNil() predicate.Person {
	return predicate.Person(sql.FieldNotNull(FieldWbOcrOrderNo))
}

// WbOcrOrderNoEqualFold applies the EqualFold predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoEqualFold(v string) predicate.Person {
	return predicate.Person(sql.FieldEqualFold(FieldWbOcrOrderNo, v))
}

// WbOcrOrderNoContainsFold applies the ContainsFold predicate on the "wb_ocr_order_no" field.
func WbOcrOrderNoContainsFold(v string) predicate.Person {
	return predicate.Person(sql.FieldContainsFold(FieldWbOcrOrderNo, v))
}

// WbFaceOrderNoEQ applies the EQ predicate on the "wb_face_order_no" field.
func WbFaceOrderNoEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldEQ(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoNEQ applies the NEQ predicate on the "wb_face_order_no" field.
func WbFaceOrderNoNEQ(v string) predicate.Person {
	return predicate.Person(sql.FieldNEQ(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoIn applies the In predicate on the "wb_face_order_no" field.
func WbFaceOrderNoIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldIn(FieldWbFaceOrderNo, vs...))
}

// WbFaceOrderNoNotIn applies the NotIn predicate on the "wb_face_order_no" field.
func WbFaceOrderNoNotIn(vs ...string) predicate.Person {
	return predicate.Person(sql.FieldNotIn(FieldWbFaceOrderNo, vs...))
}

// WbFaceOrderNoGT applies the GT predicate on the "wb_face_order_no" field.
func WbFaceOrderNoGT(v string) predicate.Person {
	return predicate.Person(sql.FieldGT(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoGTE applies the GTE predicate on the "wb_face_order_no" field.
func WbFaceOrderNoGTE(v string) predicate.Person {
	return predicate.Person(sql.FieldGTE(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoLT applies the LT predicate on the "wb_face_order_no" field.
func WbFaceOrderNoLT(v string) predicate.Person {
	return predicate.Person(sql.FieldLT(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoLTE applies the LTE predicate on the "wb_face_order_no" field.
func WbFaceOrderNoLTE(v string) predicate.Person {
	return predicate.Person(sql.FieldLTE(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoContains applies the Contains predicate on the "wb_face_order_no" field.
func WbFaceOrderNoContains(v string) predicate.Person {
	return predicate.Person(sql.FieldContains(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoHasPrefix applies the HasPrefix predicate on the "wb_face_order_no" field.
func WbFaceOrderNoHasPrefix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasPrefix(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoHasSuffix applies the HasSuffix predicate on the "wb_face_order_no" field.
func WbFaceOrderNoHasSuffix(v string) predicate.Person {
	return predicate.Person(sql.FieldHasSuffix(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoIsNil applies the IsNil predicate on the "wb_face_order_no" field.
func WbFaceOrderNoIsNil() predicate.Person {
	return predicate.Person(sql.FieldIsNull(FieldWbFaceOrderNo))
}

// WbFaceOrderNoNotNil applies the NotNil predicate on the "wb_face_order_no" field.
func WbFaceOrderNoNotNil() predicate.Person {
	return predicate.Person(sql.FieldNotNull(FieldWbFaceOrderNo))
}

// WbFaceOrderNoEqualFold applies the EqualFold predicate on the "wb_face_order_no" field.
func WbFaceOrderNoEqualFold(v string) predicate.Person {
	return predicate.Person(sql.FieldEqualFold(FieldWbFaceOrderNo, v))
}

// WbFaceOrderNoContainsFold applies the ContainsFold predicate on the "wb_face_order_no" field.
func WbFaceOrderNoContainsFold(v string) predicate.Person {
	return predicate.Person(sql.FieldContainsFold(FieldWbFaceOrderNo, v))
}
