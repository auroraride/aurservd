...
// was not loaded in eager-loading.
func (e EnterpriseEdges) AssetOrErr() ([]*Asset, error) {
	if e.loadedTypes[11] {
		return e.Asset, nil
	}
...
func (e *Enterprise) assignValues(columns []string, values []any) error {
...
func (e *Enterprise) Value(name string) (ent.Value, error) {
