...
func And(predicates ...predicate.EnterpriseBill) predicate.EnterpriseBill {
	return predicate.EnterpriseBill(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.EnterpriseBill) predicate.EnterpriseBill {
	return predicate.EnterpriseBill(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.EnterpriseBill) predicate.EnterpriseBill {
	return predicate.EnterpriseBill(sql.NotPredicates(p))
}
