...
var (
	...
	AllocateTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{AllocateColumns[20]},
	...
	AssetColumns = []*schema.Column{
		...
		{Name: "rent_locations_type", Type: field.TypeUint8, Nullable: true, Comment: "出租位置类型 1:仓库 2:门店 3:站点 4:运维 5:电柜 6:骑手"},
		{Name: "brand_id", Type: field.TypeUint64, Nullable: true},
		...
		{Name: "rent_locations_id", Type: field.TypeUint64, Nullable: true, Comment: "出租位置ID"},
	...
	AssetTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "asset_enterprise_station_rent_asset",
			...
			},
			{
				...
				Columns:    []*schema.Column{AssetColumns[24]},
				RefColumns: []*schema.Column{SubscribeColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
	...
	AssetCheckDetailsColumns = []*schema.Column{
		...
		{Name: "last_modifier", Type: field.TypeJSON, Nullable: true, Comment: "最后修改人"},
		{Name: "remark", Type: field.TypeString, Nullable: true, Comment: "管理员改动原因/备注"},
		{Name: "sn", Type: field.TypeString, Nullable: true, Comment: "资产SN"},
	...
	AssetCheckDetailsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{AssetCheckDetailsColumns[18]},
				RefColumns: []*schema.Column{WarehouseColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
	...
	AssetMaintenanceDetailsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{AssetMaintenanceDetailsColumns[10]},
				RefColumns: []*schema.Column{MaterialColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	AssetScrapColumns = []*schema.Column{
		...
		{Name: "operate_role_type", Type: field.TypeUint8, Nullable: true, Comment: "报废人员角色类型 0:业务后台 1:门店 2:代理 3:运维 4:电柜 5:骑手 6:资产后台"},
	...
	AssetTransferDetailsColumns = []*schema.Column{
		...
		{Name: "in_operate_type", Type: field.TypeUint8, Nullable: true, Comment: "入库角色类型 0:业务后台 1:门店 2:代理 3:运维 4:电柜 5:骑手 6:资产后台"},
	...
	AssetTransferDetailsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{AssetTransferDetailsColumns[13]},
				RefColumns: []*schema.Column{AssetManagerColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "asset_transfer_details_employee_in_operate_employee",
				Columns:    []*schema.Column{AssetTransferDetailsColumns[13]},
				RefColumns: []*schema.Column{EmployeeColumns[0]},
				OnDelete:   schema.SetNull,
			},
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AssetTransferDetailsColumns[9]},
			},
			{
				Name:    "assettransferdetails_transfer_id_asset_id",
				Unique:  false,
				Columns: []*schema.Column{AssetTransferDetailsColumns[12], AssetTransferDetailsColumns[11]},
			},
		},
	}
	...
	BatteryFlowColumns = []*schema.Column{
		...
		{Name: "battery_flows", Type: field.TypeUint64, Nullable: true},
	...
	BatteryFlowTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{BatteryFlowColumns[13]},
				RefColumns: []*schema.Column{RiderColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				Name:    "batteryflow_sn",
				Unique:  false,
				Columns: []*schema.Column{BatteryFlowColumns[4]},
				Annotation: &entsql.IndexAnnotation{
					OpClass: "gin_trgm_ops",
					Types: map[string]string{
						"postgres": "GIN",
	...
	FaultTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "fault_asset_ebike",
				Columns:    []*schema.Column{FaultColumns[15]},
				RefColumns: []*schema.Column{AssetColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "fault_asset_battery",
	...
	PurchaseOrderColumns = []*schema.Column{
		...
		{Name: "next_date", Type: field.TypeTime, Nullable: true, Comment: "下次支付日期"},
	...
	PurchaseOrderTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "purchaseorder_created_at",
				Unique:  false,
				Columns: []*schema.Column{PurchaseOrderColumns[1]},
			},
			{
				Name:    "purchaseorder_deleted_at",
				Unique:  false,
				Columns: []*schema.Column{PurchaseOrderColumns[3]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PurchaseOrderColumns[7]},
			},
			{
				Name:    "purchaseorder_status",
				Unique:  false,
				Columns: []*schema.Column{PurchaseOrderColumns[8]},
			},
			{
	...
	// PurchasePaymentColumns holds the columns for the "purchase_payment" table.
	PurchasePaymentColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint64, Increment: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
	...
	PurchasePaymentTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{PurchasePaymentColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
		...
		Indexes: []*schema.Index{
			{
				Name:    "purchasepayment_created_at",
				Unique:  false,
				Columns: []*schema.Column{PurchasePaymentColumns[1]},
			},
			{
				Name:    "purchasepayment_deleted_at",
				Unique:  false,
				Columns: []*schema.Column{PurchasePaymentColumns[3]},
			},
			{
...
func init() {
	...
	AssetTable.ForeignKeys[10].RefTable = RiderTable
	AssetTable.ForeignKeys[11].RefTable = StoreTable
	AssetTable.ForeignKeys[12].RefTable = StoreTable
	AssetTable.ForeignKeys[13].RefTable = SubscribeTable
	AssetTable.ForeignKeys[14].RefTable = WarehouseTable
	...
	AssetTransferDetailsTable.ForeignKeys[2].RefTable = AssetManagerTable
	AssetTransferDetailsTable.ForeignKeys[3].RefTable = EmployeeTable
	...
	FaultTable.ForeignKeys[2].RefTable = RiderTable
	FaultTable.ForeignKeys[3].RefTable = AssetTable
	FaultTable.ForeignKeys[4].RefTable = AssetTable
	...
	OrderTable.ForeignKeys[3].RefTable = AgentTable
	OrderTable.ForeignKeys[4].RefTable = OrderTable
	OrderTable.ForeignKeys[5].RefTable = AssetTable
