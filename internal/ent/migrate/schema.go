...
var (
	...
	SubscribeColumns = []*schema.Column{
		...
		{Name: "days", Type: field.TypeInt, Comment: "总天数 = 骑士卡天数 + 改动天数 + 暂停天数 + 已缴纳逾期滞纳金天数"},
		{Name: "plan_days", Type: field.TypeInt, Comment: "骑士卡天数", Default: 0},
		{Name: "alter_days", Type: field.TypeInt, Comment: "改动天数", Default: 0},
		{Name: "pause_days", Type: field.TypeInt, Comment: "暂停天数", Default: 0},
		{Name: "remaining", Type: field.TypeInt, Comment: "剩余天数, 复数为逾期", Default: 0},
	...
	SubscribeTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{SubscribeColumns[19]},
				RefColumns: []*schema.Column{RiderColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SubscribeColumns[15]},
			},
			{
				Name:    "subscribe_start_at_end_at",
				Unique:  false,
				Columns: []*schema.Column{SubscribeColumns[16], SubscribeColumns[17]},
			},
		},
	}
