...
var (
	...
	AssetTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AssetColumns[12], AssetColumns[21]},
			},
		},
	}
	...
	PurchasePaymentColumns = []*schema.Column{
		...
		{Name: "billing_date", Type: field.TypeTime, Nullable: true, Comment: "账单日期", SchemaType: map[string]string{"postgres": "date"}},
