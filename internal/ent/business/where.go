...
func Rto(v bool) predicate.Business {
	return predicate.Business(sql.FieldEQ(FieldRto, v))
}
...
func RtoEQ(v bool) predicate.Business {
	return predicate.Business(sql.FieldEQ(FieldRto, v))
}

// RtoNEQ applies the NEQ predicate on the "rto" field.
func RtoNEQ(v bool) predicate.Business {
	return predicate.Business(sql.FieldNEQ(FieldRto, v))
}
