...
// WhereHasEbikeAllocate applies a predicate to check if query has an edge ebike_allocate.
func (f *ContractFilter) WhereHasEbikeAllocate() {
	f.Where(entql.HasEdge("ebike_allocate"))
}
