...
// GetTableName returns table name for RiderBelongs.
func (rb *RiderBelongs) GetTableName() string {
	return "rider_belongs"
}

// GetID returns id for RiderBelongs.
func (rb *RiderBelongs) GetID() uint64 {
	return rb.ID
}
