...
const (
	// Label holds the string label denoting the questioncategory type in the database.
	...
	// Table holds the table name of the questioncategory in the database.
...
// Columns holds all SQL columns for questioncategory fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
