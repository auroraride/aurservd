...
func (rfuu *RiderFollowUpUpdate) Save(ctx context.Context) (int, error) {
	...
	return withHooks(ctx, rfuu.sqlSave, rfuu.mutation, rfuu.hooks)
}
...
func (rfuu *RiderFollowUpUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *RiderFollowUpUpdate {
	rfuu.modifiers = append(rfuu.modifiers, modifiers...)
	return rfuu
}
...
func (rfuuo *RiderFollowUpUpdateOne) Save(ctx context.Context) (*RiderFollowUp, error) {
	...
	return withHooks(ctx, rfuuo.sqlSave, rfuuo.mutation, rfuuo.hooks)
}
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (rfuuo *RiderFollowUpUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *RiderFollowUpUpdateOne {
	rfuuo.modifiers = append(rfuuo.modifiers, modifiers...)
	return rfuuo
}
