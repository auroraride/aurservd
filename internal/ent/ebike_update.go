...
func (eu *EbikeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if eu.mutation.CreatorCleared() {
		_spec.ClearField(ebike.FieldCreator, field.TypeJSON)
	}
