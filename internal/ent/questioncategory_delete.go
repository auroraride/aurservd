...
// QuestionCategoryDelete is the builder for deleting a QuestionCategory entity.
...
func (qcd *QuestionCategoryDelete) Where(ps ...predicate.QuestionCategory) *QuestionCategoryDelete {
...
func (qcd *QuestionCategoryDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(questioncategory.Table, sqlgraph.NewFieldSpec(questioncategory.FieldID, field.TypeUint64))
...
// QuestionCategoryDeleteOne is the builder for deleting a single QuestionCategory entity.
type QuestionCategoryDeleteOne struct {
	qcd *QuestionCategoryDelete
}

// Where appends a list predicates to the QuestionCategoryDelete builder.
func (qcdo *QuestionCategoryDeleteOne) Where(ps ...predicate.QuestionCategory) *QuestionCategoryDeleteOne {
...
func (qcdo *QuestionCategoryDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{questioncategory.Label}
	default:
		return nil
	}
}
