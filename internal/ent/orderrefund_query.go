...
func (orq *OrderRefundQuery) FirstIDX(ctx context.Context) uint64 {
...
func (orq *OrderRefundQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (orq *OrderRefundQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := orq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (orq *OrderRefundQuery) loadOrder(ctx context.Context, query *OrderQuery, nodes []*OrderRefund, init func(*OrderRefund), assign func(*OrderRefund, *Order)) error {
	...
	nodeids := make(map[uint64][]*OrderRefund)
	for i := range nodes {
		fk := nodes[i].OrderID
...
func (orq *OrderRefundQuery) Modify(modifiers ...func(s *sql.Selector)) *OrderRefundSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ors *OrderRefundSelect) Modify(modifiers ...func(s *sql.Selector)) *OrderRefundSelect {
