...
func (vq *VersionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (vq *VersionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (vq *VersionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (vq *VersionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (vq *VersionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (vq *VersionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := vq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (vq *VersionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(version.Table, version.Columns, sqlgraph.NewFieldSpec(version.FieldID, field.TypeUint64))
	_spec.From = vq.sql
...
type VersionQueryWith string

var ()

func (vq *VersionQuery) With(withEdges ...VersionQueryWith) *VersionQuery {
