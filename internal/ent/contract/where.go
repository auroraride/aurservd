...
func LastModify(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
...
func LastModifyEQ(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLastModify), v))
	})
}
...
func LastModifyNEQ(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
...
func LastModifyIn(vs ...time.Time) predicate.Contract {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LastModifyNotIn(vs ...time.Time) predicate.Contract {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LastModifyGT(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
...
func LastModifyGTE(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
...
func LastModifyLT(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
...
func LastModifyLTE(v time.Time) predicate.Contract {
	return predicate.Contract(func(s *sql.Selector) {
