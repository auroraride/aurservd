...
func (AssetHistory) Fields() []ent.Field {
	return []ent.Field{
		field.Int("from_location_type").Comment("开始位置类型 1:仓库 2:门店 3:电柜 4:站点 5:骑手 6:运维"),
		field.Int("from_location_id").Comment("开始位置ID"),
		field.Int("to_location_type").Comment("目标位置类型 1:仓库 2:门店 3:电柜 4:站点 5:骑手 6:运维"),
		field.Int("to_location_id").Comment("目标位置ID"),
	}
}
