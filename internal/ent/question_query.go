...
func (qq *QuestionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Question, error) {
	...
	if query := qq.withCategory; query != nil {
		if err := qq.loadCategory(ctx, query, nodes, nil,
			func(n *Question, e *QuestionCategory) { n.Edges.Category = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (qq *QuestionQuery) loadCategory(ctx context.Context, query *QuestionCategoryQuery, nodes []*Question, init func(*Question), assign func(*Question, *QuestionCategory)) error {
	...
	query.Where(questioncategory.IDIn(ids...))
...
type QuestionQueryWith string

var (
	QuestionQueryWithCategory QuestionQueryWith = "Category"
)

func (qq *QuestionQuery) With(withEdges ...QuestionQueryWith) *QuestionQuery {
	for _, v := range withEdges {
		switch v {
		case QuestionQueryWithCategory:
			qq.WithCategory()
		}
	}
	return qq
