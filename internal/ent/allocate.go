...
// was not loaded in eager-loading, or loaded but was not found.
func (e AllocateEdges) BatteryOrErr() (*Asset, error) {
	if e.Battery != nil {
...
func (*Allocate) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case allocate.FieldCreator, allocate.FieldLastModifier:
			values[i] = new([]byte)
		case allocate.FieldID, allocate.FieldRiderID, allocate.FieldSubscribeID, allocate.FieldEmployeeID, allocate.FieldCabinetID, allocate.FieldStoreID, allocate.FieldBrandID, allocate.FieldStationID, allocate.FieldAgentID, allocate.FieldStatus, allocate.FieldEbikeID, allocate.FieldBatteryID:
...
func (a *Allocate) QueryBattery() *AssetQuery {
