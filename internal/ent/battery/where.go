...
func SubscribeIDNEQ(v uint64) predicate.Battery {
	return predicate.Battery(sql.FieldNEQ(FieldSubscribeID, v))
}

// SubscribeIDIn applies the In predicate on the "subscribe_id" field.
func SubscribeIDIn(vs ...uint64) predicate.Battery {
	return predicate.Battery(sql.FieldIn(FieldSubscribeID, vs...))
}

// SubscribeIDNotIn applies the NotIn predicate on the "subscribe_id" field.
func SubscribeIDNotIn(vs ...uint64) predicate.Battery {
	return predicate.Battery(sql.FieldNotIn(FieldSubscribeID, vs...))
}

// SubscribeIDGT applies the GT predicate on the "subscribe_id" field.
func SubscribeIDGT(v uint64) predicate.Battery {
	return predicate.Battery(sql.FieldGT(FieldSubscribeID, v))
}

// SubscribeIDGTE applies the GTE predicate on the "subscribe_id" field.
func SubscribeIDGTE(v uint64) predicate.Battery {
	return predicate.Battery(sql.FieldGTE(FieldSubscribeID, v))
}

// SubscribeIDLT applies the LT predicate on the "subscribe_id" field.
func SubscribeIDLT(v uint64) predicate.Battery {
	return predicate.Battery(sql.FieldLT(FieldSubscribeID, v))
}

// SubscribeIDLTE applies the LTE predicate on the "subscribe_id" field.
func SubscribeIDLTE(v uint64) predicate.Battery {
	return predicate.Battery(sql.FieldLTE(FieldSubscribeID, v))
}

// SubscribeIDIsNil applies the IsNil predicate on the "subscribe_id" field.
func SubscribeIDIsNil() predicate.Battery {
	return predicate.Battery(sql.FieldIsNull(FieldSubscribeID))
}

// SubscribeIDNotNil applies the NotNil predicate on the "subscribe_id" field.
func SubscribeIDNotNil() predicate.Battery {
...
// HasFlowsWith applies the HasEdge predicate on the "flows" edge with a given conditions (other predicates).
...
func And(predicates ...predicate.Battery) predicate.Battery {
	return predicate.Battery(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.Battery) predicate.Battery {
	return predicate.Battery(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.Battery) predicate.Battery {
	return predicate.Battery(sql.NotPredicates(p))
}
